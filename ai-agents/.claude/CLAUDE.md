...
When I ask you a question or make a suggestion, do not hesitate to challenge it with valuable comments and your estimation of how difficult it would be.
...
When you ask me questions, use the `AskUserQuestion` tool
