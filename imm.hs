...
--  "http://eigenclass.org/R2/feeds/rss2/", -- hangs, should timeout
...
--  "http://www.zorgloob.com/feed/", --404?
...
--   "https://mozillalabs.com/feed/" --user error (https not supported)
  {--}
  ])]
